...
from .pyocd_core import is_pyocd_available as pyocd_available
from .pyocd_core import is_pyocd_supported as is_pyocd_supported_from_mcu
    ...
    **kwargs,
    ...
    for task in tasks:
        ...
        if not fw_info:
            ...
            continue
        fw_file: Path = config.firmware_folder / fw_info.firmware_file
