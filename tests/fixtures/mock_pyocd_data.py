...
BUILTIN_PYOCD_TARGETS = {
    "stm32f429xi": {"vendor": "STMicroelectronics", "part_number": "STM32F429XI", "source": "builtin"},
    "stm32f412xg": {"vendor": "STMicroelectronics", "part_number": "STM32F412XG", "source": "builtin"},
...
PACK_PYOCD_TARGETS = {
    "stm32h563zitx": {"vendor": "STMicroelectronics", "part_number": "STM32H563ZI", "source": "pack"},
    "stm32h503cbtx": {"vendor": "STMicroelectronics", "part_number": "STM32H503CB", "source": "pack"},
}
...
class MockMCU:
    ...
    def __init__(self, board_id: str, cpu: str, description: str, port: str = "unknown"):
        ...
        self.port = port
        # Attributes used by mpflash.list.mcu_table / worklist code
        self.board = board_id
        self.variant = ""
        self.serialport = "MOCK"
        self.version = ""
    ...
    def get_mcu_info(self, *args, **kwargs):  # pragma: no cover - test stub
        """No-op stub; tests pre-populate attributes."""
        return None

    def get_board_info_toml(self, *args, **kwargs):  # pragma: no cover - test stub
        return None
...
ERROR_SCENARIOS = {
    "pyocd_not_installed": {"exception": ImportError("No module named 'pyocd'"), "expected_error": "pyOCD is not installed"},
    "no_probes_found": {"probes": [], "expected_error": "No debug probes available"},
    "probe_connection_failed": {"exception": Exception("Failed to connect to target"), "expected_error": "Cannot connect to probe"},
    "invalid_firmware_file": {"file_path": "/nonexistent/firmware.bin", "expected_error": "Firmware file not found"},
    "pack_install_timeout": {"exception": TimeoutError("Pack installation timed out"), "expected_error": "timed out"},
}
