...
from mpflash.common import FlashParams
    ...
    with patch("mpflash.ask_input.config") as mock_config:
        ...
        with patch("inquirer.prompt") as mock_prompt:
            ...
            with patch("mpflash.ask_input.ask_port_board") as mock_ask_port_board:
                mock_ask_port_board.return_value = [
                    MagicMock(name="board_question")
                ]
    ...
    with patch("mpflash.ask_input.config") as mock_config:
        ...
        with patch("inquirer.prompt") as mock_prompt:
            ...
            with patch("mpflash.ask_input.ask_port_board") as mock_ask_port_board:
                ...
                assert result.erase == False, "Erase setting should be preserved"
                assert result.bootloader == True, "Bootloader setting should be preserved"
